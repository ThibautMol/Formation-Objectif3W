                ...
                <tbody>
                    ...
                    <?php if (isset($_SESSION['course'])): ?>
                        <?php foreach ($_SESSION['course'] as $data) :?>
                            ...
                            <tr>
                                <div>
                                    <td class="text-center"><?=(!empty($_SESSION['course'])) ? count($_SESSION['course']) : "0" ?></td>
                                    <td class="text-center"><?=$data['product_name']?></td>
                                    <td class="text-center"><?=$data['quantity']?></td>
                                    <td class="text-center"><input class="form-check-input" type="checkbox" name="id<?=(!empty($_SESSION['course'])) ? count($_SESSION['course']) : "0" ?>" value="<?=(!empty($_SESSION['course'])) ? count($_SESSION['course']) : "0" ?>"></td>
                                </div>   
                            </tr>
                        <?php endforeach;?>
                    <?php endif;?>
...
<?=(!empty($_SESSION['course'])) ? count($_SESSION['course']) : "0" ?>
